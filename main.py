...
class MainFrame(QWidget):
    ...
    def init_ui(self):
        ...
        hbox_path = QHBoxLayout(self)
        self.file_path_ctrl = QLineEdit(self)
        ...
        self.file_path_choice_button = QPushButton("选择文件", self)
        ...
        hbox_path = QHBoxLayout(self)
        self.save_path_ctrl = QLineEdit(self)
        ...
        self.save_path_choice_button = QPushButton("选择路径", self)
        ...
        hbox_log = QHBoxLayout(self)
        self.log_ctrl = QTextEdit(self)
